...
//        System.out.println(ab);//34rewrwe[]
        ...
        //StringBuilder
        //It is a mutable sequenve of character it can be changed
        StringBuilder a = new StringBuilder("hello");
        String ab  = "helol";
        StringBuilder aa = new StringBuilder(ab);
        a.append(aa);
        System.out.println(a);//here a and aa are added
        a.insert(2,'x');//at index 2 x is added
        a.setCharAt(3,'b'); //at index 3 the char is changed with b
